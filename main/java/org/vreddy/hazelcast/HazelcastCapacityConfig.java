...
/**
 * Hazelcast configuration class for capacity cache.
 *
 */
@Component
public class HazelcastConfig {
    ...
    your public adddress here..
    @Value("${hazelcast.publicAddress:10.92.249.14}")
    private String publicAddress;

    your list of members here
    @Value("${hazelcast.members:10.92.249.14:9600,10.92.249.14:9601,10.92.249.14:9602}")
